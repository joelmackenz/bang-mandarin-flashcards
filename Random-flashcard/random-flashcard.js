...
class RandomFlashcard extends React.Component {
    ...
    chooseRandCard() {
        ...
        let rand = Math.floor(Math.random() * (randMandCardArray.length))    
        console.log(rand);    
        let randMandCard = this.props.currentLesson[rand];
    ...
    revealCard() {
        ...
        let matchingPinyinCard = dictionary[this.props.currentLesson[this.currentCardNum]][1];
        this.setState({
