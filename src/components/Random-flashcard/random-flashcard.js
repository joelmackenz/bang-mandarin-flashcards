...
class RandomFlashcard extends React.Component {
    ...
    revealCard() {
        ...
        let matchingPinyinCard =
            dictionary[this.state.activeEntries[this.currentCardNum]][3];
        this.setState({
    ...
    render() {
        ...
        if (this.state.englishCardShow) {
            englishCardDisplay = <p>{this.state.englishCard}</p>;
        } else {
            englishCardDisplay = <p></p>;
        }
            ...
            <div className="outer-box">
                <div className="button-box">
                    ...
                    <Checkbox
                        className="checkbox"
                        title="English"
                        onChange={this.showEnglish}
                    />
                    <Checkbox
                        className="checkbox"
                        title="Phrases"
                        onChange={this.togglePhrases}
                    />
                </div>
